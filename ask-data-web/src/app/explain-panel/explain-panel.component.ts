...
@Component({
  ...
  `,
  styles: [`
    .explain { margin-top:1rem; padding:1rem; background:#fff; border:1px solid #e5e7eb; border-radius:.5rem; }
    .sql pre { background:#0f172a; color:#e2e8f0; padding:.5rem; border-radius:.3rem; overflow:auto; }
  `]
})
